...
var Pixio = function() {
    ...
    var masonryBox = function() {
        ...
        if (jQuery('#masonry2').length > 0) {
            $('#masonry2').masonry({
                itemSelector: '.grid-item',
                columnWidth: '.grid-sizer',
                percentPosition: true
            })
            var self2 = jQuery("#masonry2");
        }
    ...
    var handleoffcanvas = function() {
        $('.offcanvas-btn').click(function() {
            if ($('#' + $(this).attr('data-target')).hasClass('is-closed')) {
                $('.offcanvas').addClass('is-closed');
                $('#' + $(this).attr('data-target')).removeClass('is-closed');
            } else {
                $('#' + $(this).attr('data-target')).addClass('is-closed');
            }
    ...
    var handletouchspin = function() {
        ...
        function incrementValue(e) {
            ...
            var parent = $(e.target).closest('div , td');
