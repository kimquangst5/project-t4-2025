...
` : ""}`, t),
	...
	function Pn(e, t, r) {
		...
		, {scope: o={}, params: s=[]}={}) => {
			...
			if (typeof n == "function") {
				...
				n.finished ? (Ie(i, n.result, a, s, r),
	...
	var Ue = e => {
	  ...
	  , Ds = Ue(e => e ? `on${Mt(e)}` : "")
	  , Nt = (e, t) => e !== t && (e === e || t === t);
	var Dt = new WeakMap, we = [], k, Z = Symbol("iterate"), Pt = Symbol("Map key iterate");
	function ai(e) {
	...
	function nn(e=!1, t=!1) {
		return function(n, i, o) {
			...
			t) ? a : It(a) ? !s || !qe(i) ? a.value : a : be(a) ? e ? ln(a) : Qe(a) : a
		}
	}
	var hi = gi();
	function gi(e=!1) {
	...
	y("data", e => Me(e));
	y("root", e => G(e));
	y("refs", e => (e._x_refs_proxy || (e._x_refs_proxy = B(Ii(e))),
	e._x_refs_proxy));
	function Ii(e) {
		let t = [];
		return j(e, r => {
